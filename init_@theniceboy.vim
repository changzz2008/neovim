...
set splitright
set splitbelow
set noshowmode "设置是否在左下角显示如&ldquo;一INSERT--&rdquo;之类的状态栏
set showcmd
set wildmenu
set ignorecase
set smartcase
...
" Press space twice to jump to the next 'v' and edit it
...
" === MarkdownPreview
" ===
"let g:mkdp_path_to_chrome = '$ProgramFiles(x86)/Google/Chrome/Application/Chrome'
...
" === FZF
" ===
"czzset rtp+=/usr/local/opt/fzf
"czzset rtp+=/home/linuxbrew/.linuxbrew/opt/fzf
"czzset rtp+=/home/david/.linuxbrew/opt/fzf
